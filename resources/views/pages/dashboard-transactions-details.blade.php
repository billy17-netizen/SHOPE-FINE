...
@section('title', 'Store Dashboard Transaction Detail Page')
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="product-subtitle">
                                                    {{$transaction->transaction->address_one}}
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="product-title">
                                                ...
                                                <div class="product-subtitle">
                                                    {{$transaction->transaction->address_two}}
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="product-title">
                                            ...
                                            <div class="col-12 col-md-3">
                                                ...
                                                <select class="form-control" id="status" name="shipping_status"
                                                        v-model='status'>
                                            ...
                                            <template v-if="status === 'SHIPPING'">
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" name="resi" type="text"
                                                           v-model="resi">
                                                </div>
                                                <div class="col-md-2">
                                                    <button class="btn btn-success btn-block mt-4"
                                                            type="submit">Update Resi
                                                    </button>
                                                </div>
                                            </template>
                                        </div>
